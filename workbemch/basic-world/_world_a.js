...
function drawEnclosingPartition(part) {
    if (part) {
        ...
        rect(part.lowX, part.lowY, part.partSize, part.partSize);
        fill(0, 30); noStroke();
...
function makeEntities() {
    ...
    // Wall data
    ppWall[0] = paintWall(color(160, 255, 160, 80), 8);  // Green
    ppWall[1] = paintWall(color(200, 200, 255), 8);  // Blue
    data = [
        [125, 75, 60, 280],
        [75, 340, 120, 310],
        [270, 66, 375, 80],
    ...
    // Mover data
    ppMover[0] = paintArrow(color(160, 255, 160, 48), color(20, 200, 20, 48)); // Green
    ppMover[1] = paintArrow(color(180, 180, 255), color(20, 20, 160));  // Blue
    data = [
        [380, 125, 10],
        [70, 85, 10],
        [175, 210, 10],
    ...
    // Wander data
    ppVehicle[0] = paintPerson(color(160, 255, 160, 48), color(20, 200, 20, 48)); // Green
    ppVehicle[1] = paintPerson(color(180, 180, 255), color(20, 20, 200)); // Blue
    data = [
        [222, 333, 10],
        [111, 85, 10],
        [300, 233, 10],
