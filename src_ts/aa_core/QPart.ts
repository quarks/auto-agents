...
class QPart {
     ...
     * @returns 
     */
    static getStats(tree: QPart): WorldStats {
     ...
     */
    static __getStats(part: QPart, stat: WorldStats) {
        // Collisions
     ...
     */
    constructor(parent: QPart, cX: number, cY: number, size: number,
    ...
    populateGrid(grid: Array<Array<QPart>>, partSize: number, minCellSize: number) {
    ...
    */
     ...
     */
    _moveEnities(part: QPart, time: number) {
    ...
    parent: QPart = undefined;
    children: Array<QPart> = undefined;
