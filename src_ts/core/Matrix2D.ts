...
*/
class Matrix2D {
    // @todo Some problems with translation yet to iron out
     ...
     */
    transformVector(vPoint: Vector2D): Vector2D {
     ...
     */
    identity() {
        this.matrix._11 = 1; this.matrix._12 = 0; this.matrix._13 = 0;
        this.matrix._21 = 0; this.matrix._22 = 1; this.matrix._23 = 0;
        this.matrix._31 = 0; this.matrix._32 = 0; this.matrix._33 = 1;
        return this;
    }
     ...
     */
    scale(xScale: number, yScale: number): Matrix2D {
        let mat = new Matrix();
     ...
     */
    rotate(p0: number | Vector2D, p1?: Vector2D): Matrix2D {
    ...
    /**
      ...
      * @phidden
      */
    _rotVectors(fwd: Vector2D, side: Vector2D) {
        let mat = new Matrix();
...
class Matrix {
    ...
    _21: number = 0; _22: number = 0; _23: number = 0;
    _31: number = 0; _32: number = 0; _33: number = 0;
    ...
    set(n: Array<number>) {
        this._11 = n[0]; this._12 = n[1]; this._13 = n[2];
        this._21 = n[3]; this._22 = n[4]; this._23 = n[5];
        this._31 = n[6]; this._32 = n[7]; this._33 = n[8];
    }
