...
class Vector2D {
     ...
     */
    getReflect(norm: Vector2D): Vector2D {
    ...
    /**
        ...
        * @returns this vector
        */
    random(m0?: number, m1?: number): Vector2D {
    ...
    static dot(v0: Vector2D, v1: Vector2D): number {
     ...
     */
    static add(v0: Vector2D, v1: Vector2D): Vector2D {
     ...
     */
    static mult(v: Vector2D, s: number): Vector2D {
     ...
     * @return the calculated vector
     */
    static div(v: Vector2D, s: number): Vector2D {
        return new Vector2D(v.x / s, v.y / s);
    }
     ...
     */
    static isSecondInFOVofFirst(posFirst: Vector2D, facingFirst: Vector2D, fovFirst: number,
        posSecond: Vector2D): boolean {
    ...
    * @return the randomised vector
     */
    static random(m0?: number, m1?: number): Vector2D {
        let angle = Math.random() * 2 * Math.PI;
