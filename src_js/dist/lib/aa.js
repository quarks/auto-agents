...
var _a, _Entity_NEXT_ID, _Entity_id, _Entity_pos, _Entity_colRad, _Entity_tag, _Entity_fsm, _Entity_painter, _Entity_visible, _Artefact_lowX, _Artefact_highX, _Artefact_lowY, _Artefact_highY, _Artefact_width, _Artefact_height, _Wall_start, _Wall_end, _Wall_norm, _Wall_repelSide, _Fence_lowX, _Fence_lowY, _Fence_highX, _Fence_highY, _Fence_tri, _Fence_walls, _Fence_contour, _Mover_domain, _Mover_prevPos, _Mover_vel, _Mover_side, _Vehicle_autopilot, _Vehicle_forceRecorder, _Vehicle_force, _Vehicle_accel, _World_instances, _World_births, _World_deaths, _World_domain, _World_population, _World_dispatcher, _World_painter, _World_width, _World_height, _World_tree, _World_elapsedTime, _World_maxObstacleSize, _World_preventOverlap, _World_addEntity, _World_delEntity, _World_ensureNoOverlap, _World_testForOverlap, _Domain_lowX, _Domain_highX, _Domain_lowY, _Domain_highY, _Domain_cX, _Domain_cY, _Domain_width, _Domain_height, _Domain_constraint, _QPart_instances, _QPart_entities, _QPart_parent, _QPart_children, _QPart_level, _QPart_depth, _QPart_lowX, _QPart_highX, _QPart_lowY, _QPart_highY, _QPart_cX, _QPart_cY, _QPart_childAt, _AutoPilot_instances, _AutoPilot_owner, _AutoPilot_flags, _AutoPilot_boxLength, _AutoPilot_target, _AutoPilot_arriveRate, _AutoPilot_arriveDist, _AutoPilot_fleeTarget, _AutoPilot_fleeRadius, _AutoPilot_evadeAgent, _AutoPilot_hideFromAgent, _AutoPilot_pursueAgent, _AutoPilot_pursueOffset, _AutoPilot_agent0, _AutoPilot_agent1, _AutoPilot_getPathEdges, _AutoPilot_pathTarget, _AutoPilot_path, _AutoPilot_edges, _AutoPilot_cyclicPath, _AutoPilot_psd, _AutoPilot_pad, _AutoPilot_currEdge, _AutoPilot_weight, _Telegram_sender, _Telegram_receiver, _Telegram_msgID, _Telegram_delay, _Telegram_extraInfo, _Dispatcher_telegrams, _Dispatcher_world, _FiniteStateMachine_owner, _FiniteStateMachine_currentState, _FiniteStateMachine_previousState, _FiniteStateMachine_globalState, _State_name, _State_world, _Graph_instances, _Graph_nodes, _Graph_floatingEdges, _Graph_name, _Graph_searchDFS, _Graph_searchBFS, _Graph_searchDijkstra, _Graph_searchAstar, _Graph_isSearchValid, _GraphNode_edges, _GraphNode_id, _GraphNode_p, _GraphNode_graphCost, _GraphNode_fullCost, _GraphEdge_from, _GraphEdge_to, _GraphEdge_name, _GraphEdge_cost, _Force_forceName, _Force_min, _Force_max, _Force_s1, _Force_s2, _Force_n, _Force_weight, _ForceRecorder_owner, _ForceRecorder_forces, _ForceRecorder_nbrReadings, _Vector2D_p;
export { Entity, Artefact, Obstacle, Wall, Fence, Mover, Vehicle };
export { ForceRecorder, Force };
export { Graph, GraphNode, GraphEdge };
export { World, Domain, QPart, AutoPilot };
export { FiniteStateMachine, State, Dispatcher, Telegram };
export { Geom2D, Matrix2D, Matrix, Transform, Vector2D };
export { sceneFromJSON, graphFromJSON };
export { VECTOR2D, MATRIX2D, GEOM2D };
class Entity {
