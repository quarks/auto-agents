...
class FiniteStateMachine {
    ...
    set owner(entity) { __classPrivateFieldSet(this, _FiniteStateMachine_owner, entity, "f"); }
    ...
    update(elapsedTime, world) {
        ...
        this.globalState?.execute(__classPrivateFieldGet(this, _FiniteStateMachine_owner, "f"), elapsedTime, world);
        // same with the current state
        // this['_currentState']?.execute(this._owner, elapsedTime, world);
        __classPrivateFieldGet(this, _FiniteStateMachine_currentState, "f")?.execute(__classPrivateFieldGet(this, _FiniteStateMachine_owner, "f"), elapsedTime, world);
    }
